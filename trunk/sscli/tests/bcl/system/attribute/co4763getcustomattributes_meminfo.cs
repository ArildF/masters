 ...
 override public bool TestGetCustomAttributes (MemberInfo mem)
   ...
   try  
     ...
     do
       ...
       iCountErrors++;
       Util.printerr ("E_6_498s - attrs.Length != iCountTotalAttrs-2");
       ...
       iCountErrors++;
       Util.printerr ("E_6_jhd3 - attrs.Length Failed!");
       Util.print ("Expected: " + iCountTotalAttrs + "; Returned: " + attrs.Length);
       }
       iCountTestcases++;
       strLoc="L_001.3";
 ...
 override public bool TestGetCustomAttributes2 (MemberInfo mem)
   ...
   try  
     ...
     do
       ...
       if (attrs.Length != (iCountTotalAttrs-2)) {
       iCountErrors++;
       Util.printerr ("E_16_498s - attrs.Length != iCountTotalAttrs-2");
       Util.print ("Expected: " + (iCountTotalAttrs-2) + ";Returned: " + attrs.Length);					
       }
       iCountTestcases++;
       strLoc="L_16_001.2";
       ...
       if (attrs.Length != (iCountTotalAttrs-2)) {
       iCountErrors++;
       Util.printerr ("E_16_fk23 - attrs.Length != iCountTotalAttrs-2");
       Util.print ("Expected: " + (iCountTotalAttrs-2) + ";Returned: " + attrs.Length);					
       }
       }
       else if (attrs.Length != iCountTotalAttrs) {
       iCountErrors++;
       Util.printerr ("E_16_jhd3 - attrs.Length Failed!");
       Util.print ("Expected: " + iCountTotalAttrs + "; Returned: " + attrs.Length);
       }
       iCountTestcases++;
       strLoc="L_16_001.3";
...
public class Co4763GetCustomAttributes_MemInfo
{
 ...
 public bool RunTest()
   ...
   try  
     ...
     if (attrs.Length != 0) {
     iCountErrors++;
     Util.printerr ("E_100_f3fw - attrs.Length != 0");
     ...
     if (attrs2.Length != 0) {
     iCountErrors++;
     Util.printerr ("E_2_100_f3fw - attrs2.Length != 0");
