...
namespace System.Diagnostics.SymbolStore
{
    ...
    {
#if !PLATFORM_UNIX
        public const String NATIVE_DLL = "ildbsymbols.dll";
#else //PLATFORM_UNIX
  #if __APPLE__
        public const String NATIVE_DLL = "libildbsymbols.dylib";
  #else
        public const String NATIVE_DLL = "libildbsymbols.so";
  #endif // ! __APPLE__
#endif //PLATFORM_UNIX
    ...
    // Document
    //
    class SymDocument : ISymbolDocument
    {
    ...
    class SymDocumentWriter : ISymbolDocumentWriter
    {
    ...
    // SymVariable
    //-----------------------------------------------------------------------
    class SymVariable : ISymbolVariable
    {
    ...
    class SymWriter : ISymbolWriter
    {
        ...
        readonly static Guid CLSID_CorSymWriter = new Guid(0x108296C1, 0x281E, 0x11D3, 0xBD, 0x22, 0x00, 0x00, 0xF8, 0x08, 0x49, 0xBD);
        readonly static Guid IID_ISymUnmanagedWriter = new Guid(0x2DE91396, 0x3844, 0x3B1D, 0x8E, 0x91, 0x41, 0xC2, 0x4F, 0xD6, 0x72, 0xEA);
        ...
        public void Initialize(IntPtr emitter, string filename, bool fFullBuild)
        {
            ...
            hr = SymWriter_Initialize(m_Writer, emitter, filename, fFullBuild);
            if (hr < 0)
            {
    ...
    public class SymBinder : ISymbolBinder
    {
        ...
        readonly static Guid CLSID_CorSymBinder = new Guid(0xAA544D41, 0x28CB, 0x11d3, 0xBD, 0x22, 0x00, 0x00, 0xF8, 0x08, 0x49, 0xBD);
