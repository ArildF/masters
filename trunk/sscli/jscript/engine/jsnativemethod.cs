    ...
    internal sealed class JSNativeMethod : JSMethod{
      ...
      internal override Object Invoke(Object obj, Object thisob, BindingFlags options, Binder binder, Object[] parameters, CultureInfo culture){
        ...
        if (!this.hasThis && !this.hasVarargs && n == pn)
          if (binder != null)
            return this.method.Invoke(this.obj, BindingFlags.SuppressChangeType, null, this.ConvertParams(0, parameters, binder, culture), null);
          else
            return this.method.Invoke(this.obj, options, binder, parameters, culture);
        ...
        if (this.hasVarargs){
          ...
          if(n-offset > pn){
            for (int i = pn+offset; i < n; i++)
              if (i == n-1 && this.formalParams[i].ParameterType.IsArray && this.formalParams[i].IsDefined(Typeob.ParamArrayAttribute, true))
        ...
        if (binder != null)
          return this.method.Invoke(this.obj, BindingFlags.SuppressChangeType, null, this.ConvertParams(offset, arguments, binder, culture), null);
        else
          return this.method.Invoke(this.obj, options, binder, arguments, culture);
      }
