...
namespace Microsoft.JScript 
{
    ...
    internal class JSWrappedProperty : PropertyInfo, IWrappedMember{
      ...
      public override String Name{
        get{
          if (this.obj is LenientGlobalObject && this.property.Name.StartsWith("Slow"))
      ...
      public override Object[] GetCustomAttributes(Type t, bool inherit){
        return this.property.GetCustomAttributes(t, inherit);
      }
      ...
      public override bool IsDefined(Type type, bool inherit){ 
        return this.property.IsDefined(type, inherit);
      }
    }
}
