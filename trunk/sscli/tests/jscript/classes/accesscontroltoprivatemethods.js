...
function accesscontroltoprivatemethods()
{
   ...
   actualError = "";
   if (version == "7.0") expectedError = "ReferenceError: 'person2.GetAge' is not accessible from this scope";
   ...
   exceptionThrown = false;
   actualError = "";
   if (version == "7.0") expectedError = "ReferenceError: 'person5.GetAge' is not accessible from this scope";
