...
HRESULT EEToProfInterfaceImpl::CreateProfiler(WCHAR *wszCLSID, WCHAR *wszProfileDLL)
{
    // Try and CoCreate the registered profiler
    HRESULT hr = CoCreateProfiler(wszCLSID, wszProfileDLL, &g_pCallback);
