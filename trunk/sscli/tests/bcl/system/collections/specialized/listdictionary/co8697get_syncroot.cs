...
public class Co8697get_SyncRoot
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "ListDictionary.SyncRoot get";
    public static String s_strTFName        = "Co8697get_SyncRoot.cs";
    ...
    public virtual bool runTest()
    {
        ...
        try
        {
            ...
            Console.WriteLine("  toString: " + ld.SyncRoot.ToString());
            ...
            Console.WriteLine("3. SyncRoot vs ListDictionary");
            iCountTestcases++;
            root = ld.SyncRoot;
            string str = root.ToString();
            Console.WriteLine("SyncRoot.ToString(): " + str);
            if ( str.IndexOf("ListDictionary", 0) < 0 ) 
            {
                iCountErrors++;
                Console.WriteLine("Err_0003, root.ToString() doesn't contain \"ListDictionary\"");
            }
        } 
    ...
    {
        bool bResult = false;
        Co8697get_SyncRoot cbA = new Co8697get_SyncRoot();
        try 
        {
            bResult = cbA.runTest();
        } 
