...
typedef Object* (F_CALL_CONV * FastPrimitiveArrayAllocatorFuncPtr)(CorElementType type, DWORD cElements);
...
typedef Object* (F_CALL_CONV * FastObjectArrayAllocatorFuncPtr)(MethodTable *ElementType, DWORD cElements);
...
OBJECTREF AllocateObjectArray(DWORD cElements, TypeHandle ElementType, BOOL bAllocateInLargeHeap);
    ...
    // Allocate string
typedef StringObject* ( F_CALL_CONV * FastStringAllocatorFuncPtr)(DWORD cchArrayLength);
