...
// TODOPGM  postponed: 310447
  ...
  apInitScenario("test that the 'allow-multiple' clause is honored");
  
  try{
    eval("a15 a15 var bar15")
    apLogFailInfo("Exception not thrown when expected", "", "", "")
  }catch(e){}

  res = String(cls15.GetCustomAttributes(true)[0])
  if (String(res) != "a15") apLogFailInfo("wrong result obtained", "a15", res, "")

  res = String(cls16.GetCustomAttributes(true))
  if (String(res) != "a16,a16") apLogFailInfo("wrong result obtained", "a16,a16", res, "")
