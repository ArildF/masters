...
function dtfunc01() {
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "1.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "2.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "3.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "4.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "5.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "6.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "7.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "8.6 Wrong date returned");
	...
	//verify (dDate1.getSeconds(), (new Date(Date.parse(dDate2))).getSeconds(), "9.6 Wrong date returned");
