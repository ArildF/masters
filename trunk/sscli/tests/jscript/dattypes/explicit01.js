...
_long = _uint
// PGMTODOPGM
//if (_long != uint.MaxValue ) apLogFailInfo("1 Wrong Value", uint.MaxValue , _long, "")
_long = uint(uint.MaxValue )
if (_long != uint.MaxValue ) apLogFailInfo("2 Wrong Value", uint.MaxValue , _long, "")
x = long(_uint)
//if (x != uint.MaxValue ) apLogFailInfo("3 Wrong Value", uint.MaxValue , _long, "")
...
_ulong = _long
// PGMTODOPGM
//if (_ulong != long.MaxValue) apLogFailInfo("Wrong Value", long.MaxValue, _ulong, "")
...
x = ulong(_decimal)
// PGMTODOPGM
//if (x != ulong.MaxValue ) apLogFailInfo("3 Wrong Value", ulong.MaxValue , _ulong, "")
