        ...
        private ResourceSet CreateResourceSet(Stream store)
        {
            ...
            if (store.CanSeek && store.Length > 4) {
                ...
                if (bytes == MagicNumber) {
                    ...
                    if (_userResourceSet == null && (readerTypeName == null || readerTypeName.Equals(ResReaderTypeName) || readerTypeName.Equals(ResReaderTypeNameInternal)) && (resSetTypeName == null || resSetTypeName.Equals(ResSetTypeName) || resSetTypeName.Equals(ResSetTypeNameInternal))) {
#if _DEBUG
                        if (DEBUG >= 6)
