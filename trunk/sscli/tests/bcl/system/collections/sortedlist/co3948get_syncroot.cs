...
public class Co3948get_SyncRoot
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "SortedList.SyncRoot";
    public static String s_strTFName        = "Co3948get_SyncRoot.cs";
    public static String s_strTFAbbrev      = s_strTFName.Substring(0, 6);
    public static String s_strTFPath        = Environment.CurrentDirectory;
    private SortedList arrDaughter;
    private SortedList arrGrandDaughter;
    ...
    {
        bool bResult = false;
        Co3948get_SyncRoot cbA = new Co3948get_SyncRoot();
        try 
        {
            bResult = cbA.runTest();
        } 
