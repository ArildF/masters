/*=====================================================================
**
** Source:  PAL_TRY_EXCEPT_EX.c (test 1)
**
** Purpose: Tests the PAL implementation of the PAL_TRY and 
**          PAL_EXCEPT_EX functions. Exceptions are forced to ensure
...
int __cdecl main(int argc, char *argv[])
{
    ...
    */
    ...
    if (!bExcept)
    {
        Trace("PAL_TRY_EXCEPT_EX: ERROR -> It appears the code in the PAL_EXCEPT"
            " block was not executed.");
    }
