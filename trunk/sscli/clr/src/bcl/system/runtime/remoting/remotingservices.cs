...
namespace System.Runtime.Remoting {
	...
	[SecurityPermissionAttribute(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]	
        ...
        {           
            ...
            // earlier call
            Identity idObj = IdentityHolder.FindOrCreateIdentity(objectURI, url, null);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (typeName != null)
                        {
                            ...
                            Assembly assem = FormatterServices.LoadAssemblyFromString(assemNamespace);
	...
	[SecurityPermissionAttribute(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]	
        ...
        {            
            ...
            if(null != URI)
            {
                ...
                if(null == srvID)
                {
                    ...
                    srvID = RemotingConfigHandler.CreateWellKnownObject(URI);                
                }

                if(null != srvID)
                {
                    Type tmpType = srvID.ServerType;
                    if (tmpType != null && !tmpType.IsPublic)
                    {
            ...
            MarshalByRefObject tp)
        {
            ...
            bool bSameDomain;
            int domainId;
            IntPtr contextId = GetServerContextForProxy(
                                tp, 
                                out objRef, 
                                out bSameDomain,
                                out domainId);
        ...
        internal static Type InternalGetTypeFromQualifiedTypeName(String qualifiedTypeName)
        {
            ...
            if (qualifiedTypeName.Length > 4) // length of "clr:"
            {
                if (String.CompareOrdinal(qualifiedTypeName, 0, "clr:", 0, 4) == 0)
                {
                    ...
                    return LoadClrTypeWithPartialBindFallback(actualTypeName);
                }
            }
                ...
                if (String.CompareOrdinal(qualifiedTypeName, 0, "soap:", 0, 5) == 0)
                {
                    ...
                    if (type == null)
                    {
                        ...
                        try
                        {
                            ...
                            type = LoadClrTypeWithPartialBindFallback(fullTypeName);
                        }
                        catch 
                        {
            ...
            return LoadClrTypeWithPartialBindFallback(qualifiedTypeName);
        } // InternalGetTypeFromQualifiedTypeName


        private static Type LoadClrTypeWithPartialBindFallback(String typeName)
        {
