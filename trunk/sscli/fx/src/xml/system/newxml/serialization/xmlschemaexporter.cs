    ...
    public class XmlSchemaExporter {
        ...
        public XmlQualifiedName ExportTypeMapping(XmlMembersMapping xmlMembersMapping) {
            ...
            if (mapping.Members.Length == 1 && mapping.Members[0].Elements[0].Mapping is SpecialMapping) {
                ...
                XmlSchemaType type = ExportSpecialMapping(special, xmlMembersMapping.Accessor.Namespace);
        ...
        XmlSchemaElement ExportElement(ElementAccessor accessor) {
            ...
            ExportElementMapping(element, accessor.Mapping, accessor.Namespace);
            return element;
        }
        ...
        void ExportElementMapping(XmlSchemaElement element, Mapping mapping, string ns) {
            if (mapping is ArrayMapping)
                ...
                element.SchemaType = ExportSpecialMapping((SpecialMapping)mapping, ns);
            else
        ...
        XmlSchemaType ExportSpecialMapping(SpecialMapping mapping, string ns) {
        ...
        void ExportElementAccessor(XmlSchemaGroupBase group, ElementAccessor accessor, bool repeats, bool valueTypeOptional, string ns) {
            if (accessor.Any  && accessor.Name == String.Empty) {
                ...
                if (element == null) {
                    ...
                    ExportElementMapping(element, (TypeMapping)accessor.Mapping, accessor.Namespace);
                }
                if (accessor.IsTopLevelInSchema) {
