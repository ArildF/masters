...
namespace Microsoft.JScript
{
  ...
  //  4- Update Severity.
  //-------------------------------------------------------------------------------------------------------
  [Serializable] public class JScriptException : ApplicationException, IVsaError{
    ...
    protected JScriptException(SerializationInfo info, StreamingContext context)
      ...
      this.value = info.GetValue("Value", Typeob.Object);
      if (this.value == null)
        this.value = Missing.Value;
    ...
    public override void GetObjectData(SerializationInfo info, StreamingContext context) {
      ...
      info.AddValue("Value", this.value as Exception);
    }
    ...
    public override String Message{
      get{
        ...
        String code = (this.HResult & 0xFFFF).ToString();
        ...
        return Localize(((int)(this.HResult & 0xFFFF)).ToString(), culture);
      }
    }   
    ...
    public int Severity{
      get{
        ...
        if (!this.isError){
          switch ((JSError)(ec & 0xFFFF)){
            case JSError.ActiveXObjectNotSupportedOnRotor : return 4;
            ...
            case JSError.GetObjectNotSupportedOnRotor : return 4;
  ...
  public class NoContextException : ApplicationException{
    internal NoContextException() : base("No Source Context available"){
    }
  } 
