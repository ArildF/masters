...
namespace System.Reflection {
    ...
    public class Assembly : IEvidenceFactory, ICustomAttributeProvider, ISerializable
    {
        ...
        public virtual String CodeBase {
            get {
                String codeBase = nGetCodeBase(false, false);
        ...
        public virtual String EscapedCodeBase {
            get {
                String codeBase = nGetCodeBase(false, true);
                VerifyCodeBaseDiscovery(codeBase);
                return codeBase;
            }
        }
       ...
       // ICustomAttributeProvider implementation
        ...
        public Module LoadModule(String moduleName,
                                 byte[] rawModule)
        {
            return InternalLoadModule(moduleName, rawModule, null);
        }
        ...
        public Module LoadModule(String moduleName,
                                 ...
                                 byte[] rawSymbolStore)
        {
            return InternalLoadModule(moduleName, rawModule, rawSymbolStore);
        }
        ...
        */
        ...
        private Module InternalLoadModule(String moduleName,
                                          byte[] rawModule,
                                          byte[] rawSymbolStore)
        {
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern String nGetCodeBase(bool fCopiedName, bool fEscape);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        ...
        private static IPermission CreateWebPermission( String codeBase )
        {
            ...
            Type type = RuntimeType.GetTypeInternal( "System.Net.NetworkAccess, System, Version=" + Assembly.GetExecutingAssembly().GetVersion().ToString() + ", Culture=neutral, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken, false, false, true );
            ...
            type = RuntimeType.GetTypeInternal( "System.Net.WebPermission, System, Version=" + Assembly.GetExecutingAssembly().GetVersion().ToString() + ", Culture=neutral, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken, false, false, true );
