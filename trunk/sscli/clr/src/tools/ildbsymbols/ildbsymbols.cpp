...
//  pClsid                      szProgID            pfnCreateObject
    { &CLSID_CorSymReader,        L"CorSymReader",    SymReader::NewSymReader},
    { &CLSID_CorSymWriter,        L"CorSymWriter",    SymWriter::NewSymWriter},
    { &CLSID_CorSymBinder,        L"CorSymBinder",    SymBinder::NewSymBinder},
    { NULL,                       NULL,               NULL }
};
