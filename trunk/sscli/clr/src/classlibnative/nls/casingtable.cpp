...
const CHAR CasingTable::m_lpFileName[]                   = "l_intl.nlp";
const WCHAR CasingTable::m_lpMappingName[]               = L"_nlsplus_l_intl_nlp";

const CHAR CasingTable::m_lpExceptionFileName[]          = "l_except.nlp";
const WCHAR CasingTable::m_lpExceptionMappingName[]      = L"_nlsplus_l_except_nlp";
...
NativeTextInfo* CasingTable::CreateNativeTextInfo(int exceptIndex) {
    ...
    DWORD i;
    for (i = 0; i < m_pExceptionHeader[exceptIndex].NumUpEntries; i++, except++) {
