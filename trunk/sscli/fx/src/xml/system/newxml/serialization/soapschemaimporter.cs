...
namespace System.Xml.Serialization  {
    ...
    public class SoapSchemaImporter {
        ...
        ArrayMapping ImportArrayMapping(XmlSchemaType type, string ns) {
            ...
            if (restriction.Attributes.Count == 1) {
                XmlSchemaAttribute attribute = (XmlSchemaAttribute)restriction.Attributes[0];

                if (attribute.RefName.Name == Soap.ArrayType && attribute.RefName.Namespace == Soap.Encoding) {
