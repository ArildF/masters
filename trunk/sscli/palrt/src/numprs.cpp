...
#define DBLSPLIT (~0x7ffffff)
    ...
    // Create and accumulate partial products.  Since each number is
    // broken into 3 pieces, we should have a total of 9 parital products.
    // However, the lowest 1 is below our horizon of interest.  We have
    // plenty of extra bits for this not to affect the result.
    //
