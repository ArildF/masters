...
namespace Caspol
{
    ...
    public class caspol
    {
        ...
        private static CodeGroupAttributeTableEntry[] cgAttrTable =
            { new CodeGroupAttributeTableEntry( manager.GetString( "CodeGroupAttributeTable_Exclusive" ), PolicyStatementAttribute.Exclusive, "Set the policy statement Exclusive flag" ),
              new CodeGroupAttributeTableEntry( manager.GetString( "CodeGroupAttributeTable_LevelFinal" ), PolicyStatementAttribute.LevelFinal, "Set the policy statement LevelFinal flag" ),
        ...
        static String GenerateHeader()
        {
            ...
            sb.Append( manager.GetString( "PAL_Copyright_Line1" ) + " " + Util.Version.VersionString );
        ...
        static void ErrorMShip( String whichOption, String whichMShip, String message, int errorCode, bool displayMshipInfo )
        {
            ...
            //                      throw an exception here instead of exiting since we can't always
            // call Runtime.Exit().
        ...
        private static bool PolicyPrompt
        {
            ...
            set
            {
                ...
                if(!SetConfigurationString( true, "CaspolSettings", keyValue ))
                    throw new Exception(  manager.GetString( "Error_SetConfigurationString_Failed") );
            }       
        }
