...
namespace Microsoft.JScript 
{
    ...
    public sealed class ForIn : AST{
      ...
      internal override AST PartiallyEvaluate(){
        ...
        if ((ctype is ClassScope && ((ClassScope)ctype).noExpando && !((ClassScope)ctype).ImplementsInterface(typeof(IEnumerable))) ||
            (ctype != Typeob.Object && ctype is Type && !(typeof(ScriptObject).IsAssignableFrom((Type)ctype)) &&
            !typeof(IEnumerable).IsAssignableFrom((Type)ctype) && !typeof(IConvertible).IsAssignableFrom((Type)ctype))
            &&!typeof(IEnumerator).IsAssignableFrom((Type)ctype))
