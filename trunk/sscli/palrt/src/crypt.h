...
public:
    ...
    {
        static const struct { INT nLength; } s_Zero = { 0 };
        return (BigNum*)&s_Zero;
    }

    static inline BigNum* One()
    {
        static const struct { INT nLength; BASETYPE Value[1]; } s_One = { 1, { 1 } };
        return (BigNum*)&s_One;
    }

    static inline BigNum* Two()
    {
        static const struct { INT nLength; BASETYPE Value[1]; } s_Two = { 1, { 2 } };
        return (BigNum*)&s_Two;
    }
