...
namespace System.Xml.Serialization {
    ...
    public class XmlSerializer {
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public XmlSerializer(Type type, string defaultNamespace) : this(type, null, new Type[0], null, defaultNamespace) {
        }
        ...
        public void Serialize(XmlWriter xmlWriter, object o, XmlSerializerNamespaces namespaces) {
            try {
                if(tempAssembly == null){
                    ...
                    writer.Init(xmlWriter, (namespaces == null || namespaces.Count == 0 ? defaultNamespaces : namespaces).NamespaceList);
                    Serialize(o, writer);
                }
                else
                    tempAssembly.InvokeWriter(methodIndex, xmlWriter, o, (namespaces == null || namespaces.Count == 0 ? defaultNamespaces : namespaces).NamespaceList);
            }
            catch (Exception e) {
