...
public class Co3946get_SyncRoot
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "Queue.SyncRoot";
    public static String s_strTFName        = "Co3946get_SyncRoot.cs";
    public static String s_strTFAbbrev      = s_strTFName.Substring(0, 6);
    public static String s_strTFPath        = Environment.CurrentDirectory;
    private Queue arrDaughter;
    private Queue arrGrandDaughter;
    ...
    public bool runTest()
    {
        ...
        try 
        {
            do
            {
                ...
                arrGrandDaughter = Queue.Synchronized(arrSon);
                arrDaughter = Queue.Synchronized(arrMother);
                iCountTestcases++;
    ...
    void ReverseElements()
    {
        ...
        for(int i=0; i<iNumberOfElements;i++)
        {
            arrDaughter.Enqueue(i);
        }
    }
    public static void Main(String[] args)
    {
        bool bResult = false;
        Co3946get_SyncRoot cbA = new Co3946get_SyncRoot();
        try 
        {
            bResult = cbA.runTest();
        } 
