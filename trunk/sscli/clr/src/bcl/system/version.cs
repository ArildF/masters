...
namespace System {
    ...
    public sealed class Version : ICloneable, IComparable
    {
        ...
        public String ToString(int fieldCount) {
            ...
            case 3: 
                if (_Build == -1) throw new ArgumentException(Environment.GetResourceString("Arg_VersionUnset"));
                return( _Major + "." + _Minor + "." + _Build );
            case 4:
                if (_Revision == -1) throw new ArgumentException(Environment.GetResourceString("Arg_VersionUnset"));
