...
#define InterlockedExchangePointer PAL_InterlockedExchangePointer
#define InterlockedCompareExchange PAL_InterlockedCompareExchange
#define InterlockedCompareExchangePointer PAL_InterlockedCompareExchangePointer
...
#define getpeername PAL_getperrname
...
// Notice that PAL_LocalFrame can be also used to workaround a random problems 
// with alien stack frames being installed on the stack (e.g. in some PInvokes callbacks) - 
// move it to rotor_pal.h if it is used more widely
