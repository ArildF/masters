...
namespace System.Xml.Xsl {
    ...
    internal sealed class Processor : IXsltProcessor {
        ...
        internal XPathNavigator Context {
            get {
        ...
        internal static double ToDouble(Object value){
            if (value is XPathNavigator)
                return XmlConvert.ToXPathDouble(((XPathNavigator)value).Value);
            return XmlConvert.ToXPathDouble(value);
        }

        internal static bool ToBoolean(Object value){
            if (value is XPathNavigator)
                return Convert.ToBoolean(((XPathNavigator)value).Value);
