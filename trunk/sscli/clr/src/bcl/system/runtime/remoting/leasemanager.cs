...
namespace System.Runtime.Remoting.Lifetime
{
    ...
    internal class LeaseManager
    {
        ...
        internal static LeaseManager GetLeaseManager(TimeSpan pollTime)
        {
            ...
            {
                leaseManager = new LeaseManager(pollTime);
                remotingData.LeaseManager = leaseManager;
            }
        ...
        private LeaseManager(TimeSpan pollTime)
        {
            ...
            leaseTimer = new Timer(leaseTimeAnalyzerDelegate, null, (int)pollTime.TotalMilliseconds, Timeout.Infinite);
        }
