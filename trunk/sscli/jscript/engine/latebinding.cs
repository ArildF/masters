    ...
    public sealed class LateBinding{
      ...
      internal MemberInfo BindToMember(){
        ...
        if (this.obj is Type){ //Add instance members of type Type to the member list
          MemberInfo[] tmembers = Typeob.Type.GetMember(this.name, BindingFlags.Instance|BindingFlags.Public);
          int n = 0, m = 0;
      ...
      internal Object Call(Binder binder, Object[] arguments, ParameterModifier[] modifiers, CultureInfo culture,
        ...
        if (this.obj is ScriptObject || this.obj is GlobalObject){
          ...
          //The code paths below happen because Lookup and Member set last_member. Without the cache, BindToMember will not deliver a MethodInfo.
            ...
            if (member is JSMethod)
              ...
              if (dt == Typeob.Object)
              ...
              else if (dt == Typeob.GlobalObject && ((MethodInfo)member).IsSpecialName)
                ...
                if (member.IsDefined(Typeob.JSFunctionAttribute, false)){
        ...
        if (!construct && member is PropertyInfo){
          ...
          if (arguments.Length > 0 && ((PropertyInfo)member).GetIndexParameters().Length == 0){
        ...
        if (this.last_members != null && this.last_members.Length > 0)
          try{
            return LateBinding.CallOneOfTheMembers(this.last_members, arguments, construct, this.obj, binder, culture, namedParameters, engine);
          }catch(MissingMemberException){
            //No suitable constructor or method or property getter, but the value of (this.obj).(this.name) might contain a callable thing, so carry on.
          }
      ...
      internal static Object CallOneOfTheMembers(MemberInfo[] members, Object[] arguments, bool construct, Object thisob, Binder binder, CultureInfo culture, String[] namedParameters, VsaEngine engine){
        ...
        if (construct){
          ConstructorInfo cons = JSBinder.SelectConstructor(members, ref arguments, namedParameters);
          if (cons != null){
          ...
          MethodInfo meth = JSBinder.SelectMethod(members, ref arguments, namedParameters);
          if (meth != null) {
            if (meth is JSMethod )
              return ((JSMethod)meth).Invoke(thisob, thisob, (BindingFlags)0, JSBinder.ob, arguments, null);
            if (meth.IsDefined(Typeob.JSFunctionAttribute, false)){ //Dealing with a builtin function
              if (!construct){
                JSBuiltin biFunc = ((JSFunctionAttribute)meth.GetCustomAttributes(Typeob.JSFunctionAttribute, false)[0]).builtinFunction;
                if (biFunc != 0){
      ...
      internal static Object CallValue(Object val, Object[] arguments, bool construct, bool brackets, VsaEngine engine, Object thisob,
        ...
        if (construct){
          if (val is ScriptFunction){
            ...
            Type t = (Type)TypeExpression.PredefinedType[fun.name];
          ...
          old_style_behavior:
            ...
            if (brackets)
              return System.Array.CreateInstance(Typeob.Object, LateBinding.ToIndices(arguments));
        ...
        if (val != null){
          ...
          if (defaultMembers != null && defaultMembers.Length > 0){
            MethodInfo meth = JSBinder.SelectMethod(defaultMembers, ref arguments, namedParameters); //This also selects property getters
            if (meth != null)
      ...
      internal static bool DeleteValueAtIndex(Object obj, ulong index){
        ...
        return LateBinding.DeleteMember(obj, index.ToString());
      }
          ...
          try{
            switch(member.MemberType){
              ...
              case MemberTypes.Property:
                ...
                if (prop.DeclaringType == Typeob.ArrayObject){
                  ArrayObject aob = obj as ArrayObject;
                  if (aob != null) return aob.length;
                }else if (prop.DeclaringType == Typeob.StringObject){
      ...
      internal static Object GetValueAtIndex(Object obj, ulong index){
        if (obj is ScriptObject)
          if (index < UInt32.MaxValue)
            ...
            return ((ScriptObject)obj).GetMemberValue(index.ToString());
      default_property_case:
        ...
        if (type.IsCOMObject || obj is IReflect || index > Int32.MaxValue)
          return LateBinding.GetMemberValue(obj, index.ToString());
      ...
      internal void SetIndexedDefaultPropertyValue(Object ob, Object[] arguments, Object value){
        ...
        if (defaultMembers != null && defaultMembers.Length > 0){
          PropertyInfo prop = JSBinder.SelectProperty(defaultMembers, arguments);
          if (prop != null){
      ...
      internal void SetIndexedPropertyValue(Object[] arguments, Object value){
        ...
        if (this.last_members != null && this.last_members.Length > 0){
          PropertyInfo prop = JSBinder.SelectProperty(this.last_members, arguments);
          if (prop != null){
      ...
      internal static void SetValueAtIndex(Object obj, ulong index, Object value){
        if (obj is ScriptObject){
          if (index < UInt32.MaxValue)
            ...
            ((ScriptObject)obj).SetMemberValue(index.ToString(), value);
          return;
        }
      default_property_case:
        if (obj is IList){
        ...
        Type type = obj.GetType();
        if (type.IsCOMObject || obj is IReflect || index > Int32.MaxValue){
          LateBinding.SetMemberValue(obj, index.ToString(), value);
          return;
        }
      ...
      internal static void SwapValues(Object obj, uint left, uint right){
        ...
        if (obj is IExpando){
          String left_name = System.Convert.ToString(left);
          String right_name = System.Convert.ToString(right);
          IExpando eob = (IExpando)obj;
