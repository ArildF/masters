...
{   
    ...
    hr = ClrCreateManagedInstance(
        L"System.Xml.Xsl.XslTransform,System.Xml,Version=1.0.3300.0,Culture=neutral,PublicKeyToken=b77a5c561934e089",
        IID_IManagedInstanceWrapper,
        (void**)&pWrap);
    if (FAILED(hr)) {
    ...
    // make sure that the error handling is not totally broken
    hr = ClrCreateManagedInstance(
