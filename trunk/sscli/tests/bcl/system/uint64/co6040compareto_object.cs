...
public class Co6040CompareTo_Object
{
 ...
 public Boolean runTest()
   ...
   try
     ...
     UInt64 primativeULong = 100;
     UInt64 testUIntOne = ((UInt64) primativeULong );
     UInt64 testUIntTwo = ((UInt64) 2 * primativeULong );
     iCountTestcases++; 
     try {
     ...
     try {
     m_strLoc = "Starting testcase #" + iCountTestcases;
     m_strLoc = m_strLoc + "Compare to primative UInt64";
     UInt16 pInt = 100;
     ...
     m_strLoc = "Starting testcase #" + iCountTestcases;
     m_strLoc = m_strLoc + "Compare to primative UInt64";
     if ( testUIntOne.CompareTo( primativeULong ) != 0 ) ErrorCode();
     }
     catch( Exception e ) {
     iCountErrors++;
     Console.WriteLine( "Testcase["+iCountTestcases+"] -- Wrong Exception!" );
