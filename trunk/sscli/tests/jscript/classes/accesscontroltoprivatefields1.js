...
package Group4
{
   ...
   public class Student4
   {
      public function AccessAge()
      {
         ...
         actualError = "";
         if (version == "7.0") expectedError = "ReferenceError: 'person4.age' is not accessible from this scope";
...
function accesscontroltoprivatefields1(){
   ...
   actual = 0;
   if (version == "7.0") expectedError = "ReferenceError: 'person2.age' is not accessible from this scope";
   ...
   exceptionThrown = false;
   actualError = "";
   if (version == "7.0") expectedError = "ReferenceError: 'person5.age' is not accessible from this scope";
