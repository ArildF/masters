...
function unicod08() {
	...
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval=%CA%B0", "1.1 Wrong string");
	verify (str1.length, 43, "1.2 Wrong result returned");


	apInitScenario("2.  Multiple escape sequences");
	str1 = "http://www.microsoft.com/testing.asp?eval=\u3000\u02B0";
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval=%E3%80%80%CA%B0", "2.1 Wrong string");
	verify (str1.length, 44, "2.2 Wrong result returned");


	apInitScenario("3.  Multiple escape sequences separated by characters");
	str1 = "http://www.microsoft.com/testing.asp?eval\u3000=\u02B0";
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval%E3%80%80=%CA%B0", "3.1 Wrong string");
	...
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval%0A=1", "4.1 Wrong string");
	verify (str1.length, 44, "4.2 Wrong result returned");


	apInitScenario("5.  Newline escape sequence u000D");
	str1 = "http://www.microsoft.com/testing.asp?eval\u000D=1";
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval%0D=1", "5.1 Wrong string");
	...
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval%E2%80%A8=1", "6.1 Wrong string");
	verify (str1.length, 44, "6.2 Wrong result returned");


	apInitScenario("7.  Newline escape sequence u2029");
	str1 = "http://www.microsoft.com/testing.asp?eval\u2029=1";
	verify (encodeURI(str1), "http://www.microsoft.com/testing.asp?eval%E2%80%A9=1", "7.1 Wrong string");
