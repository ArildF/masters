...
public:
    ...
    static void Log(wchar_t *wszName, UINT val, UnitOfMeasure unit, wchar_t *wszDescr = 0);
    static void Log(wchar_t *wszName, UINT64 val, UnitOfMeasure unit, wchar_t *wszDescr = 0);
