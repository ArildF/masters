...
PORTABILITY_WARNING("struct CodeInfo not defined for new platform!");
...
#define METHOD_PREPAD 24
#else
PORTABILITY_WARNING("METHOD_PREPAD needs to be copied from clr/src/vm/*/cgencpu.h");
