...
@if(!@aspx)
	...
	eDesc = eNum = "unchanged";
	try{eval("function fum(i){if(i<1)import shooter;else fum(i-1);}fum(100);");}
	catch(e){eNum=e.number; eDesc=e.description;}
...
//---------------------------------------------------------------------------------------------------
	...
	eDesc = eNum = "unchanged";
	try{eval("function fum(i){if(i<1)package stuff2{public class stunt2{}};else fum(i-1);}fum(100);");}
	catch(e){eNum=e.number; eDesc=e.description;}
...
//---------------------------------------------------------------------------------------------------
	...
	eDesc = eNum = "unchanged";
	try{eval("function fum(i){if(i<1)public class stunt5{};else fum(i-1);}fum(100);");}
	catch(e){eNum=e.number; eDesc=e.description;}
...
//---------------------------------------------------------------------------------------------------
	...
	x = 0;
	eval("function fum(i){if(i<1)var x=32;else fum(i-1);}fum(100);");
