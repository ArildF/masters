...
namespace System.Runtime.Remoting.Channels {
    ...
    internal class CrossContextChannel : InternalSink, IMessageSink, IChannel, IChannelSender, IChannelReceiver
    {
        ...
        {
            // Cross context channels have the highest priority
            get { return 0; }
        }
        ...
        // Takes a complete url and extracts the channel URI from it.
        ...
        public virtual String MimeType
        {
            ...
            set { throw new NotSupportedException(Environment.GetResourceString("NotSupported_Method")); }
        }
        ...
        public virtual IMessageSink CreateMessageSink(String url, Object data, out String objectURI)
        {
            ...
            {
                CrossContextData xctxData = data as CrossContextData;
                if (null != xctxData)
                {
                    if ((RemotingConfiguration.ApplicationId.Equals(xctxData.ProcessGuid)) )
                    {
                        BCLDebug.Assert(false,"Do we need this?");
                        sink = CrossContextChannel.MessageSink;
                    }
                }
            }
