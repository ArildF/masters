    ...
    public class XmlConvert {
        ...
        public static string ToString(TimeSpan value) {
            ...
            if(hours != 0 || minutes != 0 || seconds != 0) {
                ...
                if(seconds != 0 || milliseconds != 0) {
                    ...
                    if (milliseconds != 0) {
                        sb.Append("."); // fraction of the second
                        sb.Append(ToString(milliseconds));
                    }
                    sb.Append("S");
                }
            }
        ...
        public static TimeSpan ToTimeSpan(string s) {
            ...
            try {
                ...
                if (s[pos] == 'T') {
                    ...
                    if (s[pos] == '.') {
                        ...
                        milliseconds = _parseCount(s, ref pos);;
            ...
            success:
                ...
                years += months / 12;
                months = months % 12;
                TimeSpan value = new TimeSpan(365 * years + 30 * months + days, hours, minutes, seconds, milliseconds);
                return value;
        ...
        internal static Uri ToUri(string s) {
            ...
            try {
                ...
                return new Uri(Path.GetFullPath(s), true); // relative
            }
        }
