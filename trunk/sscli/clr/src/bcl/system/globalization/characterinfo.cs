...
namespace System.Globalization {
    ...
    internal class CharacterInfo : System.Object
    {
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern byte* nativeGetCategoryDataTable();
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern ushort* nativeGetCategoryLevel2Offset();
        
        //
        // Native methods to access the Unicode numeric data tables in charinfo.nlp.
        // 
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern byte* nativeGetNumericDataTable();
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern ushort* nativeGetNumericLevel2Offset();
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern double* nativeGetNumericFloatData();
