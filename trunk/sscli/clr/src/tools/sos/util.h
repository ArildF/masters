...
void PrintString (DWORD_PTR strAddr, BOOL bWCHAR = FALSE, DWORD_PTR length=(DWORD_PTR)-1,
    WCHAR *buffer = NULL);
...
struct DumpHeapFlags
{
    ...
    DumpHeapFlags ()
        : min_size(0), max_size((DWORD_PTR)-1), bStatOnly(FALSE), bFixRange(FALSE),
