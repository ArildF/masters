...
namespace System.Runtime.Remoting.Channels {
                                                      ...
                                                      out String objectURI)
        {
            ...
            else
            {
                ...
                if (null != xadData)
                {
                    ...
                    {
                        IntPtr  srvContextID = xadData.ContextID;
    ...
    internal class CrossAppDomainData
    {
        ...
        internal virtual IntPtr ContextID {   get {return (IntPtr)_ContextID;}}
   ...
   //    objects in another AppDomain from one AppDomain.
        ...
        : InternalSink, IMessageSink
    {
        ...
        internal IntPtr _srvContextID;
        internal int _srvDomainID;
    
        internal CrossAppDomainSink(IntPtr srvContextID, int srvDomainID)
        {
