    ...
    {   
        ...
        public override String FullyQualifiedName {
            get
            {
                ...
                if (fullyQualifiedName != null && File.Exists( fullyQualifiedName ))
...
// Console.WriteLine("EnclosingType " + enclosingType.FullName);
            ...
            Type[]      parameterTypes)
        {
            try
            {
                ...
                return new MethodToken(nativeGetArrayMethodToken(typeSpec.Token, methodName, sigBytes, length, baseToken));
            }
            finally
            {
                Exit();
