...
namespace System.Reflection.Emit {
    ...
    sealed public class TypeBuilder : Type
    {
            ...
            Type[]          parameterTypes)
        {
            try
            {
                ...
                prToken.m_property = InternalDefineProperty(
                    m_module,
                    m_tdType.Token,
                    name,
                    (int) attributes,
            ...
            Type            eventtype)
        {
            try
            {
                ...
                evToken.m_event = InternalDefineEvent(
                    m_module,
                    m_tdType.Token,
                    name,
                    (int) attributes,
        ...
        public Type CreateType()
        {
            try
            {
                ...
                for (int i=0;i<size;i++)
                {
                    ...
                    InternalSetMethodIL(meth.GetToken().Token,
                                        meth.InitLocals,
                                        body,
                                        LocalSig,
                                        sigLength,
	...
	// 
            ...
            TypeBuilder     enclosingType)          // enclosing type. Null if Top level type
        {
            ...
            m_tdType.m_class = InternalDefineClass(fullname, tkParent, interfaceTokens, m_iAttr, m_module, Guid.Empty, tkEnclosingType);
        ...
        private extern int InternalDefineClass(
            String      fullname,
            int         tkParent,
            int[]       interfaceTokens,
            TypeAttributes         attr,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern int InternalDefineMethod(
            int         handle,
            String      name,
            byte[]      signature,
            int         sigLength,
        ...
        // Internal helpers to define property records
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern int InternalDefineProperty(
            Module      module,
            int         handle,
            String      name,
            int         attributes,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern int InternalDefineEvent(
            Module      module,
            int         handle,
            String      name,
            int         attributes,
