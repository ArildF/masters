//------------------------------------------------------------------------------
// <copyright file="findtype.cs" company="Microsoft">
//     
...
class App
{
  ...
  private static void PrintUsage()
  {
    ...
    Console.WriteLine("  FindType [Location] [MatchOptions] [ShowOptions] [MiscOptions] Name");
    Console.WriteLine();
    ...
    Console.WriteLine();
    Console.WriteLine(" FindType -d:C:\\ -d:\"C:\\test\\Lib\" String");
