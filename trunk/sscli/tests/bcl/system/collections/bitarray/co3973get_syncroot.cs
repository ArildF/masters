...
public class Co3973get_SyncRoot
{
    public static String s_strActiveBugNums = "";
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "BitArray.SyncRoot";
    public static String s_strTFName        = "Co3973get_SyncRoot.cs";
    ...
    public bool runTest()
    {
        ...
        try 
        {
            do
            {
                ...
                if(bitArr1.SyncRoot != bitArr1)
                {
                    iCountErrors++;
                    Console.WriteLine("Err_763dfsf! Wrong value returned");
                }
                iCountTestcases++;
                bitArr2 = new BitArray(new Int32[]{5});
                if(bitArr1.SyncRoot == bitArr2)
                {
                    iCountErrors++;
                    Console.WriteLine("Err_763dfsf! Wrong value returned");
                }
    ...
    {
        bool bResult = false;
        Co3973get_SyncRoot cbA = new Co3973get_SyncRoot();
        try 
        {
            bResult = cbA.runTest();
        } 
