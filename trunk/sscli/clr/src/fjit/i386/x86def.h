...
#define x86_jmp_abs_address(cond, absAddress, adj)                      \
	...
	adj ? cmdDWord((signed)absAddress-((signed) outPtr)-sizeof(void*)) : cmdDWord((signed)absAddress) )
...
#define x86_call_abs_address(absAddress, adj) 	           \
	cmdBlock2(				           \
	cmdByte(expNum(0xE8)),	                           \
	(adj ? cmdDWord(absAddress-((signed) outPtr)-sizeof(void*)) : cmdDWord((signed)absAddress)) )
