...
namespace System.Xml.Schema {
    ...
    // The Compiler class processes the Schema document and 
    // calls SchemaBuilder to build internal validation information
    internal sealed class Compiler {
        ...
        private XmlSchemaParticle CannonicalizeElement(XmlSchemaElement element, bool substitution) {
            if (substitution && (element.BlockResolved & XmlSchemaDerivationMethod.Substitution) == 0) {
