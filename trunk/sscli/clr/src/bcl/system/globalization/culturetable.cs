...
namespace System.Globalization {
    ...
    internal class CultureTable {
        ...
        unsafe internal static int GetDataItemFromName(String name) {
            ...
            for (int i = 0; i < m_headerPtr->numCultures; i++) {
                ...
                if (String.nativeCompareOrdinal(name, new String(itemName), true) == 0) {                    
                    ...
                    //                       m_itemPtr[i].dateItemIndex is the record number for
        ...
        **Exceptions: None.
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern char* nativeGetStringPoolStr(int offset);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern CultureInfoHeader* nativeGetHeader();
        
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private unsafe static extern NameOffsetItem* nativeGetNameOffsetTable();
        }       
