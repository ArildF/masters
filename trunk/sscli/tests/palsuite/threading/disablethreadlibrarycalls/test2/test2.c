...

{
    /* local variables */
#if WIN32
    const char* rgchLibraryFile1 = "dllmain1";
    const char* rgchLibraryFile2 = "dllmain2";
    char        szFunction[] = "_GetAttachCount@0";
#else
#if defined(__APPLE__)
    const char* rgchLibraryFile1 = "dllmain1.dylib";
    const char* rgchLibraryFile2 = "dllmain2.dylib";
#else   // __APPLE__
    const char* rgchLibraryFile1 = "dllmain1.so";
    const char* rgchLibraryFile2 = "dllmain2.so";
#endif  // __APPLE__
    char        szFunction[] = "GetAttachCount";
#endif
    HANDLE      hLib1 = NULL;
    HANDLE      hLib2 = NULL;
    LPTESTFUNC  pFunc1;
