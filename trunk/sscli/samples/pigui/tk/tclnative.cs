...
namespace SharedSourceCLI.TK
{
    ...
    [CallConvCdecl] internal unsafe delegate int Tcl_AppInitProc(Tcl_Interp* interp);
    [CallConvCdecl] internal unsafe delegate int Tcl_CmdProc(IntPtr clientData, 
        Tcl_Interp* interp, int argc, char** argv);        
    [CallConvCdecl] internal unsafe delegate int Tcl_CmdDeleteProc(IntPtr clientData);            
