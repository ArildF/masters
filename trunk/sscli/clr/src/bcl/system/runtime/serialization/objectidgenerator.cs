...
namespace System.Runtime.Serialization {
    ...
    public class ObjectIDGenerator {
        ...
        private int FindElement(Object obj, int hashcode, out bool found) {
            return FindElement(obj, hashcode, 0, out found);
        }
    
        private int FindElement(Object obj, int hashcode, int hashIncrement, out bool found) {
            ...
            //We didn't find it, so we have to hash again and try once more;
            return FindElement(obj, hashcode+hashIncrement, hashIncrement, out found);
        }
