...
void SYNCEnterCriticalSection(LPCRITICAL_SECTION lpCriticalSection, BOOL internal);
void SYNCLeaveCriticalSection(LPCRITICAL_SECTION lpCriticalSection, BOOL internal);
