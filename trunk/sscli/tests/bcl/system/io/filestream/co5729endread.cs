...
public class Co5729EndWrite
{
    ...
    public bool runTest()
    {
        ...
        try
        {
            ...
            strLoc = "Loc_200aa";
            fs2 = new FileStream(filName, FileMode.Create);
            iar = fs2.BeginWrite(new Byte[]{1,2}, 0, 2, null, null);
            iCountTestcases++;
            try 
            {
                fs2.EndRead(iar);
    ...
    {
        bool bResult = false;
        Co5729EndWrite cbA = new Co5729EndWrite();
        try 
        {
            bResult = cbA.runTest();
        } 
