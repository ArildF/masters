		 ...
		 OUT LPSTR *lpFilePart)
{
    ...
    else
    {
        ...
        max_len+= GetCurrentDirectoryA (0, NULL); 
        ...
        /* build full path */
        if(!GetCurrentDirectoryA(max_len,lpUnixPath))
        {
...
this function simply the given path into the new buffer.
--*/
DWORD
PALAPI
GetLongPathNameW(
		 ...
		 IN DWORD cchBuffer)
{
    ...
    /* On file system where short vs long path names are not supporting
