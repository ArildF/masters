...
namespace System.IO {
    ...
    public sealed class Directory {
        ...
        public static DirectoryInfo CreateDirectory(String path) {
            ...
            if (fullPath.EndsWith( Path.DirectorySeparatorChar ))
                ...
                demandDir = fullPath + Path.DirectorySeparatorChar + ".";
        ...
        internal static void InternalCreateDirectory(String fullPath, String path) {
            ...
            for (int j = 0; j < list.Count; j++)
            {
                ...
                if (!r) __Error.WinIOError(Marshal.GetLastWin32Error(), Path.GetDirectoryName(name));
            }
        }
       ...
       // Returns an array of Files in the DirectoryInfo specified by path
        ...
        public static String[] GetFiles(String path,String searchPattern)
        {
            ...
            String [] fileNames = InternalGetFiles(fullPath,searchPattern);
    ...
    // given search criteria (ie, "*.txt"). We disallow .. as a part of the search criteria
        ...
        public static String[] GetFileSystemEntries(String path,String searchPattern)
        {
           ...
           String [] dirs = InternalGetDirectories(fullPath,searchPattern);
           String [] files = InternalGetFiles(fullPath,searchPattern);
        ...
        **Exceptions:
        ...
        public static void Move(String sourceDirName,String destDirName) {
            ...
            String sourcePath;
            if (fullsourceDirName.EndsWith( Path.DirectorySeparatorChar ))
                sourcePath = fullsourceDirName;
            else
                sourcePath = fullsourceDirName + Path.DirectorySeparatorChar;

            String destPath;
            if (fulldestDirName.EndsWith( Path.DirectorySeparatorChar ))
                destPath = fulldestDirName;
            else
                destPath = fulldestDirName + Path.DirectorySeparatorChar;
