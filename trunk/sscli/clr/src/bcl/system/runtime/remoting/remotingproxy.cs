...
namespace System.Runtime.Remoting.Proxies {
    ...
    internal class RemotingProxy : RealProxy, IRemotingTypeInfo 
    {
        ...
        // Important. sync these flags with remoting.h (RPFLAG_XXX)
        internal const int flgUninitialized     = 0x00000000;  
        internal const int flgInitialized       = 0x00000001;
        internal const int flgActivateInContext = 0x00000002;
        ...
        internal virtual bool Initialized 
        {
            get { return ((_flags&flgInitialized) == flgInitialized); }

            set { _flags |= (value ? flgInitialized : flgUninitialized);}
        }
