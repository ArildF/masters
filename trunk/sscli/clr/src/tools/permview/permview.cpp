...
#undef WszLoadString
#endif // WszLoadString
#define WszLoadString(g_hInst, uID, lpBuffer, cchBufferMax) LoadResourceString(uID, lpBuffer, cchBufferMax)

#define MESSAGE_DLL L"permview.satellite"
...
HRESULT DumpDeclarativeSecurity(HANDLE hFile, LPWSTR szFile)
{
    ...
    PAL_TRY {
        ...
        pFiles = (mdFile*)malloc(dwFiles * sizeof(mdFile));
