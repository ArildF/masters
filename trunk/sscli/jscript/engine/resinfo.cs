    ...
    public class ResInfo{
      ...
      public ResInfo(string resinfo, bool isLinked){
        ...
        if (numParts == 2){
          ...
          if (String.Compare(info[numParts-1], "public", true, CultureInfo.InvariantCulture) == 0){
            flagPresent = true;
          }else if (String.Compare(info[numParts-1], "private", true, CultureInfo.InvariantCulture) == 0){
            this.isPublic = false;
            flagPresent = true;
          }
