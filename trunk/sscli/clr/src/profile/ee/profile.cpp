...
HRESULT PALAPI ProfilerCreateInstance(WCHAR *wszProfileDLL,
                                      REFCLSID   rclsid,
                                      REFIID     riid,
                                      void     **ppv)
{
 ...
 */
HRESULT CoCreateProfiler(WCHAR *wszCLSID, WCHAR *wszProfileDLL, ICorProfilerCallback **ppCallback)
{
    ...
    hr = ProfilerCreateInstance(wszProfileDLL, clsid, IID_ICorProfilerCallback, (LPVOID *)ppCallback);
