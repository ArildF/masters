...
BEGIN_CLASS_DUMP_INFO(ArrayClass)
  CDI_CLASS_MEMBER_OFFSET_BITFIELD(m_dwRank, offset, 8)
  CDI_CLASS_MEMBER_OFFSET_BITFIELD(m_ElementType, offset, 8)
...
BEGIN_CLASS_DUMP_INFO(FieldDesc)
  CDI_CLASS_MEMBER_OFFSET_BITFIELD(m_mb, offset1, 32)
  CDI_CLASS_MEMBER_OFFSET_BITFIELD(m_dwOffset, offset2, 32)
...
BEGIN_CLASS_DUMP_INFO(gc_heap)
  CDI_CLASS_STATIC_ADDRESS(large_blocks_size)
  CDI_CLASS_STATIC_ADDRESS(g_max_generation)

  /* other static members used in strike/utils.cpp; ignored */
  CDI_CLASS_STATIC_ADDRESS(large_np_objects)
  CDI_CLASS_STATIC_ADDRESS(large_p_objects)
...
BEGIN_CLASS_DUMP_INFO(large_object_block)
  CDI_CLASS_MEMBER_OFFSET(next)
END_CLASS_DUMP_INFO(large_object_block)
...
BEGIN_CLASS_DUMP_INFO(TypeDesc)
  CDI_CLASS_MEMBER_OFFSET_BITFIELD(m_Type, offset, 8)
...
BEGIN_CLASS_DUMP_TABLE(g_ClassDumpData)
  ...
  CDT_CLASS_ENTRY(large_object_block)
