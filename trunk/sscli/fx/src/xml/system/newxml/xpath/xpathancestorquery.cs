...
namespace System.Xml.XPath {
    ...
    internal sealed class XPathAncestorQuery : BaseAxisQuery {
        ...
        internal override IQuery Clone() {
            if (m_qyInput != null)
                return new 
                XPathAncestorQuery(m_qyInput.Clone(),_fMatchSelf, m_Name,m_Prefix,m_URN,m_Type);
            else
                return new XPathAncestorQuery(null,_fMatchSelf,m_Name,m_Prefix,m_URN,m_Type);
        }        
    }
}
