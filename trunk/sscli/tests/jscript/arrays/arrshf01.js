...
//  This test fails right now.  It takes forever to execute
//	apInitScenario("12 Shift from large Array of undefined elements");
//	arr1 = new Array(iLargestNumber);
//	verify (arr1.shift(), undefined, "12.1 Shift returned wrong value");
//	verify (arr1.length, iLargestNumber-1, "12.2 Shift didn't decrement length correctly");
//	verify (arr1.shift(), undefined, "12.3 Shift returned wrong value");
//	verify (arr1.length, iLargestNumber-2, "12.4 Shift didn't decrement length correctly");
//	verify (arr1.shift(), undefined, "12.5 Shift returned wrong value");
//	verify (arr1.length, iLargestNumber-3, "12.6 Shift didn't decrement length correctly");
