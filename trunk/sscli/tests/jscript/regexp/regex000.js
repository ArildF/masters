...
//-----------------------------------------------------------
	apInitScenario ("1. Test cases for testing JS-regular expression constructor/function");
		...
		re = RegExp (pat);
		verify (re, "/(?![4-6_y-z]+)??a*/igm", "passing a constructed RegExp as parameter to RegExp function", "");

		re = new RegExp (pat);
		verify (re, "/(?![4-6_y-z]+)??a*/igm", "passing a constructed RegExp as parameter to RegExp constructor", "");
