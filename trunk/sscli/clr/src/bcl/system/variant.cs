...
namespace System {
    ...
    internal struct Variant {
        ...
        public Variant ChangeType(Type ctype) {
    		if (ctype==null)
        ...
        public static void VariantToTypedByRef(TypedReference byrefValue,Variant v)
    	{
    		...
    		InternalVariantToTypedByRef(byrefValue,ref v);
    	}
    	[MethodImplAttribute(MethodImplOptions.InternalCall)]
    	private extern static Variant InternalVariantToTypedByRef(TypedReference byrefValue, ref Variant v);
