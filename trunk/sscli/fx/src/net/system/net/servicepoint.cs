...
namespace System.Net {
    ...
    public class ServicePoint {
        ...
        internal virtual HttpAbortDelegate SubmitRequest(HttpWebRequest request) {
            return SubmitRequest(request, null);
        }

        internal HttpAbortDelegate SubmitRequest(HttpWebRequest request, string connName) {
            //
            ...
            lock(this) {
                ...
                connToUse = connGroup.FindConnection(connName);
            }
            ...
            return connToUse.SubmitRequest(request);
        }
