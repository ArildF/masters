...
#define COMPILEANDLINKEXE "cl /nologo /DWIN32 /D_X86_=1 /Di386=1 /DPAL_PORTABLE_SEH=1 /Gz /Zi /Zl /Od /W3 rotor_pal.lib /Fe"
#define COMPILEANDLINKDLL "cl /nologo /DWIN32 /D_X86_=1 /Di386=1 /DPAL_PORTABLE_SEH=1 /Gz /Zi /Zl /Od /W3 rotor_pal.lib /LD /Fe"
#define EXEEXT ".exe"
#define DLLEXT ".dll"
