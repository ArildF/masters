...
namespace Microsoft.JScript 
{
  ...
  public enum JSError {
    ...
    StringConcatIsSlow = 1255, //The plus operator is a slow way to concatenate strings. Consider using System.Text.StringBuilder instead
    ...
    CannotUseStaticSecurityAttribute = 5045, //"JScript.NET does not support static security attributes"
    GetObjectNotSupportedOnRotor = 5998, //"GetObject is not supported on this platform (it will generate an error at runtime)"
    ActiveXObjectNotSupportedOnRotor = 5999, //"ActiveXObject is not supported on this platform (it will generate an error at runtime)"
