...
namespace Microsoft.JScript 
{
    ...
    public sealed class ArrayConstructor : ScriptFunction{
      ...
      internal ArrayObject Construct(){
        return new ArrayObject(this.originalPrototype, Typeob.ArrayObject);
      }
      ...
      public ArrayObject ConstructArray(Object[] args){
        ArrayObject arrayObj = new ArrayObject(originalPrototype, Typeob.ArrayObject);
      ...
      public new ArrayObject CreateInstance(params Object[] args){
        ArrayObject arrayObj = new ArrayObject(this.originalPrototype, Typeob.ArrayObject);
        if (args.Length != 0){
          if (args.Length == 1){
            Object arg0 = args[0];
