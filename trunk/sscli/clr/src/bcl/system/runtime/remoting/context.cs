...
namespace System.Runtime.Remoting.Contexts {
    ...
    internal struct Space8 // 8x IntPtr (32 bytes total)
    {
        IntPtr _0;
        IntPtr _1;
        IntPtr _2;
    ...
    {
        // just a raw big-enough unstructured space for FEATURE_PAL
        Space8 _0;
        Space8 _1;
        Space8 _2;
        Space8 _3;
...
#else   // !__APPLE__
    internal struct Space32 // 8x Space8 (256 bytes total)
    {
        Space8 _0;
        Space8 _1;
        Space8 _2;
