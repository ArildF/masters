...
public class Co9307ctor_str_fm_fa_fs_i_b_str
{
    public static String s_strDtTmVer       = "";
    public static String s_strClassMethod   = "FileStream(String, FileMode, FileAccess, FileShare, bufferSize, IASyncResult, MsgPath)";
    public static String s_strTFName        = "Co9307ctor_str_fm_fa_fs_i_b_str.cs";
    ...
    {
        bool bResult = false;
        Co9307ctor_str_fm_fa_fs_i_b_str cbA = new Co9307ctor_str_fm_fa_fs_i_b_str();
        try 
        {
            bResult = cbA.runTest();
