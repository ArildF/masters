...
namespace System.Security.Policy {    
    ...
    internal class PolicyLevelData
    {
        ...
        internal static readonly String s_defaultPermissionSets =
           "<NamedPermissionSets>" + 
               ...
               "<PermissionSet class=\"System.Security.NamedPermissionSet\"" +
                  ...
                  "<Permission class=\"System.Security.Permissions.IsolatedStorageFilePermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
                  "<Permission class=\"System.Security.Permissions.EnvironmentPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
                  "<Permission class=\"System.Security.Permissions.FileIOPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
                  "<Permission class=\"System.Security.Permissions.FileDialogPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
                  "<Permission class=\"System.Security.Permissions.ReflectionPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
                  "<Permission class=\"System.Security.Permissions.SecurityPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Flags=\"Assertion, UnmanagedCode, Execution, ControlThread, ControlEvidence, ControlPolicy, ControlAppDomain, SerializationFormatter, ControlDomainPolicy, ControlPrincipal, RemotingConfiguration, Infrastructure\"/>" +
                  "<Permission class=\"System.Security.Permissions.UIPermission, mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "\"" +
                              "version=\"1\" " +
                              "Unrestricted=\"true\"/>" +
        ...
        internal static readonly QuickCacheEntryType s_quickCacheUnrestricted =
                ...
                QuickCacheEntryType.RequestSkipVerificationAll |
    ...
    sealed public class PolicyLevel
    {
        ...
        internal static SecurityElement CreateCodeGroupElement( String codeGroupType, String permissionSetName, SecurityElement mshipElement )
        {
            ...
            root.AddAttribute( "class", "System.Security." + codeGroupType + ", mscorlib, PublicKeyToken=" + AssemblyRef.EcmaPublicKeyToken + "" );
        ...
        internal void SetDefaultFullTrustAssemblies()
        {
            ...
            lock (m_fullTrustAssemblies)
            {
                ...
                StrongNameMembershipCondition ecmaMscorlibResource = new StrongNameMembershipCondition( ecmaBlob,
                                                       "mscorlib.resources",
                                                       s_mscorlibVersion );

                m_fullTrustAssemblies.Add( ecmaMscorlibResource );
        ...
        private static String GenerateFriendlyName( String className, Hashtable classes )
        {
            ...
            else if (!classes.Contains( type.FullName ))
            {
