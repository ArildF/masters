...
namespace System.Xml {
    ...
    internal sealed class XmlScanner {
            ...
            if (_StreamReader != null) {
                ...
                if (encoding.Equals("ucs-2") || encoding.Equals("utf-16") ||
                    ...
                    if (_nCodePage != Encoding.BigEndianUnicode.CodePage && _nCodePage != Encoding.Unicode.CodePage && encoding != s_ucs4) {
                        _nPos = _nStart;
                        throw new XmlException(Res.Xml_MissingByteOrderMark);
                    }
        ...
        // return the next token inside a dtd markup declaration (between )
        // and consume it.
...
//              break;
        ...
        private int GetChars(byte[] srcBuffer, ref int srcOffset, int srcLen, char[] destBuffer, int destOffset, bool zeroedOut)
        {
            ...
            try {
                ...
                _PreviousError = true;
                return FigureOutNewBytes(srcBuffer, ref srcOffset, srcLen, destBuffer, destOffset, zeroedOut);
            }
        ...
        internal void Reset() {
            ...
            if (_nUsed == _nPos) {
                ...
                int byteCount = _Encoding.GetByteCount(_achText, _nPos, _nUsed - _nPos);
                _ByteStart = _ByteLen - byteCount;
                _nUsed = 0;
                _nPos = 0;
